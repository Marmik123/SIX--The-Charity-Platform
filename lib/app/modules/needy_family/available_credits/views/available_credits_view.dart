...
class AvailableCreditsView extends GetView<AvailableCreditsController> {
  ...
  @override
  AvailableCreditsController controller = Get.put(AvailableCreditsController());
                ...
                : Expanded(
                    child: ListView.builder(
                      itemCount: whichRole == 'Charity'
                          ? controller.graphDetails().length
                          : 2,
                      shrinkWrap: true,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '\$${controller.graphDetails()[index].totalDonationLeft.toString()}',
                                          style: TextStyle(
                                            fontFamily: 'Gilroy',
                                            fontSize: 60.sp,
                                            fontStyle: FontStyle.normal,
