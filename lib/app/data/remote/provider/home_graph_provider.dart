...
class GraphDataProvider {
  ...
  static Future<List<GraphCategoryData>> getGraphProgramData() async {
    ...
    if (response?.statusCode == 200) {
      ...
      return List<GraphCategoryData>.generate(
          graphData.length,
          ((index) => GraphCategoryData.fromJson(
                graphData[index] as Map<String, dynamic>,
                getBarColor(index),
              )));

      /*return List<GraphData>.from(
          graphData.map<GraphData>((dynamic e) => GraphData.fromJson(
  ...
  static Future<List<GraphCategoryData>> getGraphCategoryData(
    ...
    if (response?.statusCode == 200) {
      ...
      return List<GraphCategoryData>.generate(
          graphCategoryData.length,
          ((index) => GraphCategoryData.fromJson(
                graphCategoryData[index] as Map<String, dynamic>,
                getBarColor(index),
              )));
